...
<head><link rel="stylesheet" href="{{ URL::to('/') }}/admin_header.css">
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add Manga</h1>
            
        </div>
        
        <section class="py-3">
            <div class="container">
                <form action="{{ URL::to('/') }}/insert_manga" method="post" enctype="multipart/form-data">
                    @csrf
              ...
              <div class="row">
                <div class="col-xl-10 col-lg-10 mb-4">
                  ...
                  <div class="card shadow-0 border text-white">
                    <div class="p-4">
                      <h5 class="card-title mb-3">Add Manga</h5>
                      <div class="row">
                        <div class="col-lg-6 col-md-12  mb-3">
                          <p class="mb-0">Manga name</p>
                        ...
                        <div class="col-lg-6 col-md-12 mb-3 ">
                          ...
                          <div class="form-outline border rounded-3 shadow-0">
                            <input type="text" id="typeText" name="writer" placeholder="Type here" value="{{ old('writer') }}" class="form-control" />
                          </div>
                          <span class="writer" style="color: red;">
                            @error('writer')
                            {{ $message }}    
                            @enderror
                      ...
                      <div class="justify-content-center d-flex">
                        <button class="btn btn-success shadow-0 border ">Add Manga</button> 
