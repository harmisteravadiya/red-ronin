      ...
      <div class="row gx-5">
        <aside class="col-lg-6">
          <div class="rounded-4 mb-3 d-flex justify-content-center">
              ...
              <img style="max-width: 100%; max-height: 50vh; margin: auto;" class="rounded-4 fit" src="{{ URL::to('/') }}/Images/manga/{{ $result['pic'] }}" />
        ...
        <main class="col-lg-6 detail-box py-4">
          <div class="ps-lg-3">
            ...
            <div class="mb-3">
              ...
              <span class="text-white">/per item</span>
            </div>
...
{{--   
            ...
            <a href="{{ URL::to('/') }}/add_manga_cart/{{ $result['manga_id'] }}" class="btn btn-success shadow-0"> Buy now </a>
            <a href="{{ URL::to('/') }}/add_manga_cart/{{ $result['manga_id'] }}" class="btn btn-primary shadow-0"> <i class="me-1 fa fa-shopping-basket"></i> Add to cart </a>
      ...
      <div class="row gx-4">
        <div class="col-lg-8 mb-4">
          ...
          <div class="card-body p-4 p-md-5 my-2 border rounded-2" >
            ...
            <form method="POST" action="{{ URL::to('/') }}/add_manga_review/{{ $result['manga_id'] }}">
                @csrf
              <div class="row" >
                <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="d-flex mb-3">
                  <a href="{{ URL::to('/') }}/manga_detail/{{ $data['manga_id'] }}" class="me-3">
                    <img src="{{ URL::to('/') }}/Images/manga/{{ $data['pic'] }}" style="min-width: 96px; height: 160px;" class="img-md img-thumbnail" />
                  </a>
                  <div class="info">
